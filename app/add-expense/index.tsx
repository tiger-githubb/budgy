...
import { useExpenseSuggestions } from "@/src/hooks/queries/use-suggestions.query";
...
export default function AddExpenseScreen() {
  ...
  const { data: cachedSuggestions } = useExpenseSuggestions(
    selectedCategory?.id,
  );
  ...
  }, [cachedSuggestions, title]);

  // Fetch suggestions when category changes
  // Old effect removed in favor of useExpenseSuggestions hook
  ...
  const handleDelete = () => {
    Alert.alert("Supprimer", "Veux-tu vraiment supprimer cette dépense ?", [
